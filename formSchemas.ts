...
export const registrationFormSchema: any = {
  ...
  layout: [
    ...
    },
    {
      kind: 'stack',
      spacing: 'md',
      children: [{ kind: 'field', fieldId: 'agreeToTerms' }],
    },
  ],
}
...
export const agentUpdateSchema: any = {
  ...
  layout: [
    ...
    },
    {
      kind: 'stack',
      spacing: 'md',
      children: [{ kind: 'field', fieldId: 'remarks' }],
    },
  ],
}
      ...
      children: [
        {
          kind: 'stack',
          spacing: 'md',
          children: [{ kind: 'field', fieldId: 'primarySkills' }],
        },
      ],
    },
    {
  ...
  layout: [
    {
      ...
      withDivider: true,
      children: [{ kind: 'field', fieldId: 'insuranceType' }],
    },
    {
      kind: 'section',
      title: 'Details',
